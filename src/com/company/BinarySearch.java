...
public class BinarySearch {
   ...
   Scanner commandReader = new Scanner(System.in);
        System.out.println("Welcome to Java Program to perform binary search" +
                " of int array");
    ...
    /*
    Java method to perform binary search.
    At accept an integer array and a number and return
    the index of number in the array. If number doesn't
    If number doesn't exists in array, it return -1
    @param input
    @param number
